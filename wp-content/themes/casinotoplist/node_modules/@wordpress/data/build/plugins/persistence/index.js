...
function createPersistenceInterface(options) {
  ...
  function setData(key, value) {
    data = _objectSpread({}, data, (0, _defineProperty2.default)({}, key, value));
  ...
  function createPersistOnChange(getState, reducerKey, keys) {
    ...
    if (Array.isArray(keys)) {
      ...
      var reducers = keys.reduce(function (accumulator, key) {
        return Object.assign(accumulator, (0, _defineProperty2.default)({}, key, function (state, action) {
...
persistencePlugin.__unstableMigrate = function (pluginOptions) {
  ...
  var insertUsage = (0, _lodash.get)(state, ['core/editor', 'preferences', 'insertUsage']);
  ...
  var areTipsEnabled = (0, _lodash.get)(state, ['core/nux', 'preferences', 'areTipsEnabled']);
  var hasWelcomeGuide = (0, _lodash.has)(state, ['core/edit-post', 'preferences', 'features', 'welcomeGuide']);

  if (areTipsEnabled !== undefined && !hasWelcomeGuide) {
    persistence.set('core/edit-post', (0, _lodash.merge)(state['core/edit-post'], {
      preferences: {
        features: {
