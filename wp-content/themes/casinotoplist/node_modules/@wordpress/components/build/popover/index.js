...
var Popover = function Popover(_ref2) {
  ...
  var contentRect = (0, _element.useRef)();
  ...
  (0, _element.useEffect)(function () {
    ...
    var refresh = function refresh() {
      ...
      var _computePopoverPositi = (0, _utils.computePopoverPosition)(anchor, contentRect.current, position, __unstableSticky, containerRef.current, relativeOffsetTop),
  ...
  return (0, _element.createElement)(_slotFill.Consumer, null, function (_ref5) {
    var getSlot = _ref5.getSlot;
...
PopoverContainer.Slot = function (_ref6) {
  var _ref6$name = _ref6.name,
      name = _ref6$name === void 0 ? SLOT_NAME : _ref6$name;
