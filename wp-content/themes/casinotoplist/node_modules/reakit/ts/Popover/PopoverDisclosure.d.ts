...
export declare const usePopoverDisclosure: {
    ...
    } & Pick<Partial<import("..").DisclosureStateReturn>, "visible"> & Pick<import("..").DisclosureStateReturn, "baseId" | "toggle"> & Pick<Partial<PopoverStateReturn>, "unstable_referenceRef"> & import("react").HTMLAttributes<any> & import("react").RefAttributes<any> & {
