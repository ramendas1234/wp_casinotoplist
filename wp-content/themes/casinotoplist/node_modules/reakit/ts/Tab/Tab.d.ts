...
export declare type TabOptions = RoverOptions & Pick<Required<RoverOptions>, "stopId"> & Pick<Partial<TabStateReturn>, "manual"> & Pick<TabStateReturn, "baseId" | "selectedId" | "select">;
...
export declare const useTab: {
    ...
    } & Pick<Required<RoverOptions>, "stopId"> & Pick<Partial<TabStateReturn>, "manual"> & Pick<TabStateReturn, "select" | "baseId" | "selectedId"> & React.HTMLAttributes<any> & React.RefAttributes<any> & {
