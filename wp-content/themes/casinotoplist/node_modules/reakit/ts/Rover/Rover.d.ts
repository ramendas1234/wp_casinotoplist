...
export declare type RoverOptions = TabbableOptions & unstable_IdOptions & Pick<Partial<RoverStateReturn>, "orientation" | "unstable_moves"> & Pick<RoverStateReturn, "stops" | "currentId" | "register" | "unregister" | "move" | "next" | "previous" | "first" | "last"> & {
    /**
     * Element ID.
     */
    stopId?: string;
};
export declare type RoverHTMLProps = TabbableHTMLProps & unstable_IdHTMLProps;
...
export declare const useRover: {
    ...
    __keys: readonly any[];
    __useOptions: (options: RoverOptions, htmlProps: TabbableHTMLProps) => RoverOptions;
