...
function useRoverState(initialState) {
  ...
  var idState = IdState.unstable_useIdState(sealed);
  return _rollupPluginBabelHelpers._objectSpread2({}, idState, {}, state, {
    ...
    move: React.useCallback(function (id, silent) {
      return dispatch({
        type: "move",
        id: id,
        silent: silent
...
var keys = [].concat(IdState.unstable_useIdState.__keys, ["orientation", "stops", "currentId", "unstable_pastId", "unstable_moves", "loop", "register", "unregister", "move", "next", "previous", "first", "last", "unstable_reset", "unstable_orientate"]);
