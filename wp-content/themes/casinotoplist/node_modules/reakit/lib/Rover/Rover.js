...
var useRover = createHook.createHook({
  name: "Rover",
  compose: [Tabbable.useTabbable, Id.unstable_useId],
  ...
  useProps: function useProps(options, _ref) {
    ...
    React.useEffect(function () {
      ...
      if (!rover) {
        process.env.NODE_ENV !== "production" ? warning.warning(true, "[reakit/Rover]", "Can't focus rover component because `ref` wasn't passed to component.", "See https://reakit.io/docs/rover") : void 0;
        return;
      }
