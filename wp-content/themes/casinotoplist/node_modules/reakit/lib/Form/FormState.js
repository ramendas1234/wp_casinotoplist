...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "remove":
      {
        var _array = getIn.unstable_getIn(state.values, action.name, []).slice();
...
function unstable_useFormState(initialState) {
  ...
  return _rollupPluginBabelHelpers._objectSpread2({}, id, {}, state, {
    values: state.values,
    validate: validate,
...
var keys = [].concat(IdState.unstable_useIdState.__keys, ["values", "touched", "messages", "errors", "validating", "valid", "submitting", "submitSucceed", "submitFailed", "validate", "submit", "reset", "update", "blur", "push", "remove"]);
