...
import { u as useMenuState, a as useMenuContext } from '../MenuState-449bf74e.js';
...
var useMenuBar = createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    var ref = useRef(null);
    var wrapElement = useMenuContext(ref, role, options);
...
var MenuBar = createComponent({
  ...
  useCreateElement: function useCreateElement$1(type, props, children) {
    process.env.NODE_ENV !== "production" ? warning(!props["aria-label"] && !props["aria-labelledby"] && props.role !== "menubar", "[reakit/Menu]", "You should provide either `aria-label` or `aria-labelledby` props.", "See https://reakit.io/docs/menu") : void 0;
