...
function useFocusTrap(dialogRef, nestedDialogs, options) {
  ...
  useEffect(function () {
    ...
    if (!portal) {
      process.env.NODE_ENV !== "production" ? warning(true, "[reakit/Dialog]", "Can't trap focus within modal dialog because either `ref` wasn't passed to component or the component wasn't rendered within a portal", "See https://reakit.io/docs/dialog") : void 0;
      return undefined;
    }
...
function useFocusOnHide(dialogRef, disclosuresRef, options) {
  ...
  useUpdateEffect(function () {
    ...
    if (finalFocusEl) {
      ...
      process.env.NODE_ENV !== "production" ? warning(true, "[reakit/Dialog]", "Can't return focus after closing dialog. Either render a disclosure component or provide a `unstable_finalFocusRef` prop.", "See https://reakit.io/docs/dialog") : void 0;
    }
...
function useEventListenerOutside(containerRef, disclosuresRef, nestedDialogs, eventType, listener, shouldListen) {
  ...
  useEffect(function () {
    ...
    var handleEvent = function handleEvent(event) {
      ...
      if (!container) {
        process.env.NODE_ENV !== "production" ? warning(true, "[reakit/Dialog]", "Can't detect events outside dialog because `ref` wasn't passed to component.", "See https://reakit.io/docs/dialog") : void 0;
        return;
      } // Click inside dialog
...
var useDialog = createHook({
  ...
  useOptions: function useOptions(_ref) {
    ...
    if (setModal && unstable_modal !== modal) {
      process.env.NODE_ENV !== "production" ? warning(true, "[reakit/Dialog]", "Setting `modal` prop on `Dialog` is deprecated. Set it on `useDialogState` instead.", "See https://github.com/reakit/reakit/pull/535") : void 0;
      setModal(modal);
    }
  ...
  useProps: function useProps(options, _ref2) {
    ...
    var onKeyDown = useCallback(function (event) {
      if (event.key === "Escape" && options.hideOnEsc) {
        if (!options.hide) {
          process.env.NODE_ENV !== "production" ? warning(true, "[reakit/Dialog]", "`hideOnEsc` prop is truthy, but `hide` prop wasn't provided.", "See https://reakit.io/docs/dialog") : void 0;
          return;
        }
...
var Dialog = createComponent({
  ...
  useCreateElement: function useCreateElement$1(type, props, children) {
    process.env.NODE_ENV !== "production" ? warning(!props["aria-label"] && !props["aria-labelledby"], "[reakit/Dialog]", "You should provide either `aria-label` or `aria-labelledby` props.", "See https://reakit.io/docs/dialog") : void 0;
